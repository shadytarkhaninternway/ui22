...
import { Bell, LogOut, Briefcase, Users, Building, TrendingUp, User, Search, Download, Mail, Phone, Moon, Sun, Globe, ArrowLeft } from "lucide-react";
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mb-2">
                              Applied for: <span className="font-medium text-foreground">{application.position}</span>
                            </p>
